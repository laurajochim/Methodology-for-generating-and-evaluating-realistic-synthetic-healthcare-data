...
RPPA <- readr::read_delim("tcga_data/data_rppa_zscores.txt", delim = "\t")
RPPA_demog <- readr::read_delim("tcga_data//data_clinical_patient.txt", delim = "\t")
...
continuous_RPPA <- RPPA_fac[, which(var_tcga == "c")]
